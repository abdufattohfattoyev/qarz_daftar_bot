...
urlpatterns = [
    ...
    path('admin/sms-logs/', admin_api.admin_sms_logs, name='admin-sms-logs'),
    path('admin/user/<int:user_id>/sms-allow/', admin_api.admin_user_sms_allow, name='admin-user-sms-allow'),
    ...
    path('pin/reset/request/', views.reset_pin_request, name='pin-reset-request'),
    path('pin/reset/confirm/', views.reset_pin_confirm, name='pin-reset-confirm'),
