...
export default function App() {
  ...
  if (needDevLogin) return (
    <div style={{
      ...
      <div style={{ fontSize: 22, fontWeight: 800, color: '#111', marginBottom: 10 }}>Qarz daftar</div>
      <div style={{ fontSize: 14, color: '#6b7280', textAlign: 'center', lineHeight: 1.6, marginBottom: 32 }}>
        Ilovadan foydalanish uchun Telegram botni oching va <b>/start</b> yozing
      </div>
      <a
